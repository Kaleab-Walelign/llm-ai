...
REGION_REGISTRY = {
    ...
    'afar': {
        ...
        'local_tifs': {
            'rangeland':  'Rangeland_health.tif',
            'climate':    'Climate.tif',
            'water':      'water.tif',
            'livestock':   'Live_stock_rec.tif',
    ...
    'diredawa': {
        ...
        'local_tifs': {
            'rangeland':  'dire_Range_Final.tif',
            'soil':  'dire_Soil.tif',
            'vegetation':  'dire_Vegetation.tif',
            'water':  'dire_Water_rec.tif',
            'climate':  'dire_Climate.tif',
        },
    },
